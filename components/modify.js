...
export default function Modify({navigation}) {
  ...
  return (
      <SafeAreaView style={styles.container}>
        <Text style={{color:'white' ,flex:0.15 , textAlign:'center' , paddingTop:'15%' , fontSize:35}}>Modify Staff Details</Text>
          {/* <Text > Demo Form </Text>
      <View>
    ...
    />
        ...
        <TouchableOpacity onPress={()=>modifyStaff(staff)}><Text style={{color:'red' , textAlign:'center' , paddingTop:'10%' , fontSize:35}}>Modify</Text></TouchableOpacity>
